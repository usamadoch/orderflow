...
- `components/chart/StatsIndicator.tsx` → Floating overlay rendering selected volume, delta, CVD, and liquidity stats using chart engine and liquidity history data.
