    ...
    <div className="flex flex-col h-screen overflow-hidden text-main bg-background">
      ...
      <header className="h-10 border-b border-border bg-surface flex items-center px-4 justify-between shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div className="px-2 py-1 bg-background rounded border border-border text-xs font-mono cursor-pointer hover:border-text-muted transition-colors">
            BTC/USDT
          </div>
        ...
        <div>
          {/* ConnectionStatus placeholder */}
          <div className="flex items-center gap-2 text-xs text-text-muted font-mono">
            <span className="w-1.5 h-1.5 rounded-full bg-bull shadow-[0_0_8px_var(--bull)]"></span>
            Connected
          </div>
        </div>
      </header>
