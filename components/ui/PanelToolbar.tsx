    ...
    <div className="font-sans h-8 bg-[#0D0D0D] border-b border-[#1F1F1F] flex items-center px-3 gap-3 shrink-0">
      ...
      <div className="flex gap-0.5 bg-[#080808] p-0.5 rounded-md border border-[#1A1A1A]">
        {TIMEFRAMES.map((tf) => (
          <button
            ...
            className={`px-1.5 py-0.5 rounded text-[11px] font-bold transition-all duration-200 ${
              panel.timeframe === tf
      ...
      <div className="flex gap-0.5 bg-[#080808] p-0.5 rounded-md border border-[#1A1A1A]">
        <button
          ...
          className={`px-2 py-0.5 text-[10px] font-black rounded tracking-wider transition-all duration-200 ${
      ...
      <div className="flex items-center gap-2 border-l border-[#1A1A1A] pl-3 h-5">
        <button
          ...
          className={`h-5 px-2 flex items-center justify-center rounded text-[9px] font-black tracking-widest transition-all duration-200 ${
            panel.isDrawMode
      ...
      <div className="flex items-center gap-1 border-l border-[#1A1A1A] pl-3 h-5">
        <button
          ...
          className={`h-5 w-6 flex items-center justify-center rounded text-[12px] font-bold transition-all duration-200 ${
